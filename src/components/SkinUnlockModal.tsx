  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Tier Badge */}
        <span
          className="mt-1.5 mb-2 inline-flex min-h-[16px] items-center justify-center border px-2 font-pixel text-[8px] leading-none uppercase whitespace-nowrap sm:min-h-[18px]"
          style={{
